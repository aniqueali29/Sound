...
<head>
    ...
    <title>Focus Admin: Vertical Carousel</title>
...
<body>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">UC-Vertical-Carousel</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /# column -->
                                    ...
                                    <div id="verticalCarousel" class="carousel slide vertical">
                                        <div class="carousel-inner">
                                          <div class="active item">
                                            <strong>1</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt eaque aut sint cum eum! Aspernatur, consequatur aliquam molestiae atque a magnam sequi maxime placeat quaerat.
                                          </div>
                                          <div class="item">
                                            <strong>2</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iste consequuntur tempore voluptatibus nobis eos sunt fuga eligendi saepe harum aut nesciunt quod, aperiam sint
                                          </div>
                                          <div class="item">
                                            <strong>3</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Saepe nostrum facilis voluptate iusto, qui, quia necessitatibus nihil! Ducimus, illo laborum! Illum accusantium,
                                          </div>
                                        </div>
                                     </div>
                                </div>
    ...
    <script src="assets/js/lib/jquery.min.js"></script> <script src="assets/js/lib/jquery.nanoscroller.min.js"></script><!-- nano scroller -->
    <script src="assets/js/lib/menubar/sidebar.js"></script>
    <script src="assets/js/lib/preloader/pace.min.js"></script><!-- sidebar -->
    <!-- bootstrap -->
