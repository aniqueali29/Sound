...
<head>
    ...
    <title>Focus Admin: Invoice Editable</title>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="invoice-edit">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="control-bar alert-rating">
                                                <label for="config_tax">VAT:
													<input type="checkbox" id="config_tax" />
												</label>
                                                <label for="config_tax_rate" class="taxrelated">Rate:
													<input type="text" id="config_tax_rate" value="19" />%
												</label>
                                                <label for="config_note">Remark:
													<input type="checkbox" id="config_note" />
												</label>
                                                <label for="config_date">Performance Date:
													<input type="checkbox" id="config_date" />
												</label>
                                                <div class="pull-right dib">
                                                    <a class="bg-success" href="javascript:window.print()">Print</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5">
                                            <div class="me" contenteditable>
                                                <p>
                                                    <strong>It Solution – Web Architect</strong>
                                                    <br> South Mugda
                                                    <br> New York, 1214
                                                    <br> New York
                                                </p>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="info " contenteditable>
                                                <p>
                                                    Web: <a href="http://Admin Board.com">www.Admin Board.com</a>
                                                    <br> Mail: <a href="mailto:hello@Admin Board.com">hello@Admin Board.com</a>
                                                    <br> Tel: +8801629599859
                                                    <br> Twitter: @Admin Board
                                                </p>
                                            </div>
                                        </div>

                                        <div class="col-lg-4">
                                            <div class="bank text-right" contenteditable>
                                                <p>
                                                    Bank : New York Bank
                                                    <br> Address: New York, New York
                                                    <br> IBAN: 123-45841-25685
                                                    <br> BIC: 21457-415
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <p contenteditable class="smallme m-t-30">john doe · South Mugda · New York, 1214 </p>

                                            <p contenteditable class="client">
                                                <strong>Mariam</strong>
                                                <br> South Mugda
                                                <br> New York, 1214, New York
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row m-t-30">
                                        <!--.col-->
                                        <div class="col-lg-6">
                                            <h3 class="bill" contenteditable>Invoice</h3>
                                        </div>
                                        <!--.col-->
                                        <div class="col-lg-6 text-right">
                                            <p contenteditable class="details">
                                                Date of invoice:
                                                <input type="text" class="datePicker" />
                                                <br> Invoice number:
                                                <input type="text" value="1241" />
                                                <br> Payable to:
                                                <input class="twoweeks" type="text" />
                                            </p>
                                        </div>
                                        <!--.col-->
                                    </div>
                                            ...
                                            <table class="table">
                                                <thead contenteditable>
                                                    <tr>
                                                        <th>Name</th>
                                                        <th>Description</th>
                                                        <th class="daterelated">Date</th>
                                                        <th class="w10pr">Number</th>
                                                        <th class="w12pr">Rate</th>
                                                        <th class="taxrelated">VAT</th>
                                                        <th class="w10pr">Price</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td><a class="control removeRow" href="#">x</a> <span contenteditable> T Shirt</span></td>
                                                        <td><span contenteditable>Black and White</span></td>
                                                        <td class="daterelated"><span contenteditable>Date</span></td>
                                                        <td class="amount">
                                    ...
                                    <div class="note">
                                        <h2 class="dib">Remark:</h2>
                                        <p contenteditable class="dib"> Lorem Ipsum dummy text</p>
                                    </div>
                                    <!--.note-->

                                    <div class="row">
                                        <div class="col-lg-12 text-center m-t-50">
                                            <p class="notaxrelated pull-left" contenteditable>Pursuant to § 19 UStG, the invoice does not include any VAT</p>
                                            <p contenteditable class="notdaterelated pull-right">
                                                All right reaserved, Copyright @2017
                                            </p>
                                        </div>
                                    </div>
                                </div>
