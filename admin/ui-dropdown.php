                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-dropdown">
                                    ...
                                    <div class="btn-group dropup m-b-10">
                                        <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                                            Dropup
                                        </button>
                                        <div class="dropdown-menu">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-dropdown">
                                    ...
                                    <div class="btn-group dropright m-b-10">
                                        <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                                            Dropright
                                        </button>
                                        <div class="dropdown-menu">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-dropdown">
                                    ...
                                    <div class="btn-group dropleft m-b-10">
                                        <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                                            Dropleft
                                        </button>
                                        <div class="dropdown-menu">
                                    ...
                                    <div class="btn-group">
                                        <div class="btn-group dropleft m-b-10" role="group">
                                            <button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split" data-toggle="dropdown">
