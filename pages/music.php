...
.filter-icon svg {
    width: 32px;
    height: 32px;
    fill: #00ffaa; /* Neon cyan-green for dark theme */
...
<body>
    ...
    <main class="container">
        ...
        <section class="album-grid">
            <div class="row g-4">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="quantum-card">
                        <div class="card-image-container">
                            <img src="/api/placeholder/400/320" alt="Meteora" class="card-image">
                            <div class="morph-play"><i class="fas fa-play"></i></div>
                        </div>
                        <div class="card-info">
                            <h3 class="card-title">Meteora</h3>
                            <div class="card-artist">Linkin Park</div>
                            <div class="card-meta">
                                <span>2003 <span class="genre-tag">Rock</span></span>
                                <span class="card-rating">★★★★★</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="quantum-card">
                        <div class="card-image-container">
                            <img src="/api/placeholder/400/320" alt="Rockstar" class="card-image">
                            <div class="morph-play"><i class="fas fa-play"></i></div>
                        </div>
                        <div class="card-info">
                            <h3 class="card-title">Rockstar</h3>
                            <div class="card-artist">A.R. Rahman</div>
                            <div class="card-meta">
                                <span>2011 <span class="genre-tag">Bollywood</span></span>
                                <span class="card-rating">★★★★★</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="quantum-card">
                        <div class="card-image-container">
                            <img src="/api/placeholder/400/320" alt="Blurryface" class="card-image">
                            <div class="morph-play"><i class="fas fa-play"></i></div>
                        </div>
                        <div class="card-info">
                            <h3 class="card-title">Blurryface</h3>
                            <div class="card-artist">Twenty One Pilots</div>
                            <div class="card-meta">
                                <span>2015 <span class="genre-tag">Alternative</span></span>
                                <span class="card-rating">★★★★☆</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="quantum-card">
                        <div class="card-image-container">
                            <img src="/api/placeholder/400/320" alt="Starboy" class="card-image">
                            <div class="morph-play"><i class="fas fa-play"></i></div>
                        </div>
                        <div class="card-info">
                            <h3 class="card-title">Starboy</h3>
                            <div class="card-artist">The Weeknd</div>
                            <div class="card-meta">
                                <span>2016 <span class="genre-tag">R&B</span></span>
                                <span class="card-rating">★★★★☆</span>
                            </div>
                        </div>
                    </div>
                </div>
                <!-- Hidden Album Cards (Initially not visible) -->
                <!-- Album Card 9 -->
                <div class="col-12 col-md-6 col-lg-3 hidden-card">
                    <div class="quantum-card">
                        <div class="card-image-container">
                            <img src="/api/placeholder/400/320" alt="Evolve" class="card-image">
                            <div class="morph-play"><i class="fas fa-play"></i></div>
                        </div>
                        <div class="card-info">
                            <h3 class="card-title">Evolve</h3>
                            <div class="card-artist">Imagine Dragons</div>
                            <div class="card-meta">
                                <span>2017 <span class="genre-tag">Pop Rock</span></span>
                                <span class="card-rating">★★★★☆</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 hidden-card">
                    <div class="quantum-card">
                        <div class="card-image-container">
                            <img src="/api/placeholder/400/320" alt="Revival" class="card-image">
                            <div class="morph-play"><i class="fas fa-play"></i></div>
                        </div>
                        <div class="card-info">
                            <h3 class="card-title">Revival</h3>
                            <div class="card-artist">Eminem</div>
                            <div class="card-meta">
                                <span>2017 <span class="genre-tag">Hip Hop</span></span>
                                <span class="card-rating">★★★★☆</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 hidden-card">
                    <div class="quantum-card">
                        <div class="card-image-container">
                            <img src="/api/placeholder/400/320" alt="Legends Never Die" class="card-image">
                            <div class="morph-play"><i class="fas fa-play"></i></div>
                        </div>
                        <div class="card-info">
                            <h3 class="card-title">Legends Never Die</h3>
                            <div class="card-artist">Against The Current</div>
                            <div class="card-meta">
                                <span>2017 <span class="genre-tag">Rock</span></span>
                                <span class="card-rating">★★★★☆</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 hidden-card">
                    <div class="quantum-card">
                        <div class="card-image-container">
                            <img src="/api/placeholder/400/320" alt="Circles" class="card-image">
                            <div class="morph-play"><i class="fas fa-play"></i></div>
                        </div>
                        <div class="card-info">
                            ...
                            <div class="card-meta">
                                <span>2019 <span class="genre-tag">Pop</span></span>
                                <span class="card-rating">★★★★☆</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 hidden-card">
                    <div class="quantum-card">
                        <div class="card-image-container">
                            <img src="/api/placeholder/400/320" alt="Future Nostalgia" class="card-image">
                            <div class="morph-play"><i class="fas fa-play"></i></div>
                        </div>
                        <div class="card-info">
                            <h3 class="card-title">Future Nostalgia</h3>
                            <div class="card-artist">Dua Lipa</div>
                            <div class="card-meta">
                                <span>2020 <span class="genre-tag">Pop</span></span>
                                <span class="card-rating">★★★★★</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 hidden-card">
                    <div class="quantum-card">
                        <div class="card-image-container">
                            <img src="/api/placeholder/400/320" alt="Chromatica" class="card-image">
                            <div class="morph-play"><i class="fas fa-play"></i></div>
                        </div>
                        <div class="card-info">
                            <h3 class="card-title">Chromatica</h3>
                            <div class="card-artist">Lady Gaga</div>
                            <div class="card-meta">
                                <span>2020 <span class="genre-tag">Pop</span></span>
                                <span class="card-rating">★★★★★</span>
                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 hidden-card">
                    <div class="quantum-card">
                        <div class="card-image-container">
                            <img src="/api/placeholder/400/320" alt="Justice" class="card-image">
                            <div class="morph-play"><i class="fas fa-play"></i></div>
                        </div>
                        <div class="card-info">
                            <h3 class="card-title">Justice</h3>
                            <div class="card-artist">Justin Bieber</div>
                            <div class="card-meta">
                                <span>2021 <span class="genre-tag">Pop</span></span>
                                <span class="card-rating">★★★★☆</span>
                            </div>
                        </div>
                    </div>
        ...
        <button class="d-md-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#mobileFilter" aria-controls="mobileFilter">
